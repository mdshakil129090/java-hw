...
let text="this is my first java practice";
    ...
    //ex 21  addition operator 
    let x =10;
    let y =5;
    let z =x+y;
    function addOperator(){
        document.getElementById('a_r').innerHTML=z;

    };
    //ex 22  Multiplication operator 
    let x1=100;
    let y1=5;
    let z1=x1/y1;
    function mulOperator(){
        document.getElementById('m_r').innerHTML=z1;
    };
    //ex 23 background change
    function backgroundChange(){
        document.getElementById('b_change').style.backgroundColor="red"

    };
    //ex 24size change
    function textSizeChange(){
        document.getElementById('s_ch').style.fontSize="30px";
